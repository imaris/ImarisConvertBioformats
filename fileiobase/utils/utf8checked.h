...
#include "fileiobase/utils/utf8core.h"
#include <stdexcept>
...
class invalid_code_point : public std::exception
{
  uint32_t cp;
public:
  invalid_code_point(uint32_t acp) : cp(acp) {}
...
public:
  ...
  explicit iterator (const octet_iterator& octet_it,
                     const octet_iterator& arange_start,
                     const octet_iterator& arange_end) :
    it(octet_it), range_start(arange_start), range_end(arange_end) {
